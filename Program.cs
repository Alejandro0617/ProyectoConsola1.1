    ...
    static void Main(string[] args)
    {
        try
        {
            ...
            using (var contexto = new MiContextoDeDatos())
            {
                ...
                var clienteUI = new Cliente(clienteService);
                var empresaUI = new Empresa(empresaService);
                var facturaUI = new Factura(facturaService);
                var personaUI = new Persona(personaService);
                var productosPorFacturaUI = new ProductosPorFactura(productosPorFacturaService);
                var productoUI = new Producto(productoService);
                var vendedorUI = new Vendedor(vendedorService);
